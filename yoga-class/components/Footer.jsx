...
const Footer = () => {
  return (
    ...
    <span class="text-sm text-gray-400  sm:text-center">© 2022 <a href="https://shreyaday.vercel.app/">Shreya Day™</a>. All Rights Reserved.
    </span>
    <div class="flex mt-4  space-x-6 sm:justify-center md:mt-0">
        <a href="https://www.linkedin.com/in/shreya-day-2058891a7/" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
        ...
        <a href="https://github.com/shrxyaaa" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
